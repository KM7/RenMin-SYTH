...
function setup() {
   ...
   canvas33.addEventListener("touchstart", touchStart, false);
   canvas33.addEventListener("touchmove", touchMove, false);
   canvas33.addEventListener("touchend", touchEnd, false);
   canvas33.addEventListener("touchcancel", touchCancel, false);
   // add mouse events (to see what's going on)
   canvas33.addEventListener("mousedown", mouseDown, false);
   canvas33.addEventListener("mouseup", mouseUp, false);
   canvas33.addEventListener("mousemove", mouseMove, false);
}
